...
export const LAYER_STATE_REGISTRY = Object.freeze([
  ...
  Object.freeze({ id: 'aprs', token: '3', disposition: 'enabled-only' }),
  Object.freeze({
    id: 'bhote-koshi-2026',
    token: 'h',
    disposition: 'enabled-only',
  ...
  Object.freeze({ id: 'meshtastic', token: '4', disposition: 'enabled-only' }),
  Object.freeze({
    id: 'military',
    token: 'm',
  ...
  Object.freeze({ id: 'propagation', token: '5', disposition: 'enabled-only' }),
  Object.freeze({
    id: 'radio',
    token: 'r',
    disposition: 'enabled+options',
